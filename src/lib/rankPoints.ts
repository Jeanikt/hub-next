...
/** Pontos máximos para fila Low ELO (até Gold 1 = 5). Quem tem 0–7 pode entrar. */
export const LOW_ELO_MAX_POINTS = 7;

/** Pontos mínimos para fila High ELO (Plat 1+ = 8). Quem tem 8–20 pode entrar. */
export const HIGH_ELO_MIN_POINTS = 8;
